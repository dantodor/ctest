defmodule Ctest.ScalaServer do
  use GenServer
  require Logger
  ...
  @registered_proc_name :ctest_java_server
  ...
  defp init(args, exe) do
    ...
    java_node = "__ctest__" <> self_node
    cookie = Node.get_cookie()
    jarfile = :code.priv_dir(:ctest) ++ '/sserver.jar'
    jvm_args = Application.get_env(:ctest, :jvm_args)
